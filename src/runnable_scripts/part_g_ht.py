r"""! @file part_g_ht.py
@brief Runs a set of hypothesis tests between a 1-signal distribution and 2-signal distribution
to determine the number of minimum number of data points to differentiate the 2 with some confidence.

@details Usage: `python -m src.runnable_scripts.part_g_ht <config_file>`.
Reads in a set of parameters and runs a set of hypothesis tests between a 1-signal distribution and a
2-signal distribution.The goal is to determine the number of minimum number of data points to differentiate the
2 with some confidence, specified in the configuration.  Configuration should contain a 'Parameters' section with
...
from src.distribution_utils.optimized_distributions import (
    ...
    two_signal_distribution_pdf,
    two_signal_distribution_cdf,
    generate_two_signal_distribution_samples,
)
...
if __name__ == "__main__":
    ...
    h1 = {
        "pdf": two_signal_distribution_pdf,
        "cdf": two_signal_distribution_cdf,
        "rvs": generate_two_signal_distribution_samples,
    }
    ...
    fit_config = {
        ...
        "null_limits": {"f": (0.01, 1)},
        "alt_limits": {"f1": (0.01, 1), "f2": (0.01, 1)},
    }
    ...
    for n_samples in hypothesis_distributions:
        h0_distribution = hypothesis_distributions[n_samples][0]
